...
function buildCard(spec) {
  ...
  return el('div', {
    ...
    el('div', { position: 'absolute', top: '0', left: '0', right: '0', height: '12px', background: '#0891b2' }, []),
    ...
    el('div', { justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #e2e6ea', paddingTop: '22px' }, [
      el('div', { fontSize: '26px', color: '#0891b2', fontWeight: 700 }, 'insidertape.com'),
